...
#################################################################
## Copyed by Kovrinic on 1/25/15, nothing changed just added   ##
## to github with readme explaing my cron job.                 ##
#################################################################
...
CIPUSER=UserName                      # ChangeIP.com Username
CIPPASS="Password"                    # ChangeIP.com Password
